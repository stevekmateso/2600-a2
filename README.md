> NOTE  
> This guide explains how to host the resume using GitLab Pages, following the workflow described in *Modern Technical Writing*. The university provided GitLab account does not allow for CI runners for osme reaosn. Because of this setback, the live version of the site was deployed using GitHub Pages instead. The documentation itself still demonstrates the GitLab Pages workflow.
